...
//   useEffect(() => {
//     if (isAuthenticated) navigate(isAdmin ? '/admin' : '/user', { replace: true })
...
function Login() {
  ...
  // ✅ Remove automatic redirect – ab login page hamesha dikhega
  // Agar authenticated hai to message show karenge, redirect nahi honge.
