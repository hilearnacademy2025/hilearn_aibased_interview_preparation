    ...
    <div className="relative min-h-screen">
      ...
      <main>
        <PageTransition>
          ...
          <section className="section-shell relative pt-8 pb-16">
            <div className="grid gap-10 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
              ...
              >
                ...
                <motion.h1 variants={fadeUp} className="display-font max-w-3xl text-5xl font-bold leading-tight text-[#0f1f3d] md:text-7xl">
                  Find & Hire <span className="shimmer-text">Top Tech Talent</span> in Minutes.
                </motion.h1>
                <motion.p variants={fadeUp} className="max-w-2xl text-lg leading-8 text-[#5c5a57]">
                  Access India's largest pre-vetted tech talent pool. Review detailed AI mock interview playbacks, coding scores, and communication feedback before you even say hello.
                </motion.p>
                ...
                {/* KEY METRICS */}
                <motion.div variants={fadeUp} className="mt-8 flex flex-wrap gap-6 border-t border-[#e0dbd3] pt-6">
                  <div>
                    <div className="display-font text-2xl font-bold text-[#0f1f3d]">10,000+</div>
                    <div className="text-xs uppercase tracking-[0.18em] text-[#9c9a96]">Candidates</div>
                  </div>
                  <div>
                    <div className="display-font text-2xl font-bold text-[#0f1f3d]">500+</div>
                    <div className="text-xs uppercase tracking-[0.18em] text-[#9c9a96]">Companies</div>
                  </div>
                  <div>
                    <div className="display-font text-2xl font-bold text-[#c8601a]">200+</div>
                    <div className="text-xs uppercase tracking-[0.18em] text-[#c8601a]/80">Hirings this month</div>
                  </div>
                </motion.div>
              </motion.div>
                ...
                >
                  ...
                  <div className="relative space-y-8">
                    <div className="flex items-start justify-between">
                      <div>
                        <p className="text-sm uppercase tracking-[0.24em] text-white/60">Candidate Match</p>
          ...
          {/* REST OF THE PAGE - using app design patterns */}
          ...
          <section className="section-shell mt-24 mb-16 text-center">
            ...
            >
               <motion.div
                  ...
                  className="ambient-blob top-0 left-0 h-full w-full bg-[#c8601a]/20 pointer-events-none"
                />
              <div className="relative z-10">
                <h2 className="display-font text-4xl font-bold text-white md:text-5xl">Ready to start hiring?</h2>
