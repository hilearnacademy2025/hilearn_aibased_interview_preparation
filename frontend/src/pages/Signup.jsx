...
function Signup() {
  ...
  const handleSubmit = (event) => {
    ...
    window.setTimeout(() => {
      setIsLoading(false)
      pushToast({
        title: 'Account flow submitted',
        description: 'Your signup details were captured.',
      })
  ...
  const inputFields = [
    ...
    { name: 'password', label: 'Password', type: 'password', placeholder: 'Create a secure password', colSpan: true },
