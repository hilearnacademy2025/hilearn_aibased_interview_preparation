...
//               className="relative rounded-2xl border border-blue-100 bg-white p-6 shadow-lg shadow-blue-100/40 transition-all duration-300 cursor-pointer group overflow-hidden"
//             >
...
//                 className="mb-5 flex h-14 w-14 items-center justify-center rounded-xl bg-gradient-to-br from-blue-600 to-blue-500 text-2xl text-white shadow-md shadow-blue-500/30"
//               >
//                 {feature.icon}
//               </Motion.div>
              
//               {/* Number Badge */}
//               <div className="absolute top-4 right-4 text-4xl font-bold text-blue-100/50">
//                 0{index + 1}
//               </div>
